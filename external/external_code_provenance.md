...
| MolCLR | pretrained graph baseline | `https://github.com/yuyangw/MolCLR`; checkpoint 'official pretrained GIN checkpoint' | no tagged release in the public repository used; original public code was used | None | `data/predictions/molclr/` |
